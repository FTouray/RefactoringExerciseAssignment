public class EmployeeFactory {
    ...
    private static final String DEFAULT_FILE_PATH = "EmployeeData.dat";

    /**
     * A SHORTER overload: for brand-new employees or cases
     * where you DON'T need to skip an existing record.
     * 
     * You can pass -1 (or 0) as a dummy 'currentByte'
     * when calling the longer version if needed.
     */
    ...
    private static boolean checkPpsAvailability(String ppsNumber, long currentByte) {
        ...
        try {
            application.openReadFile(DEFAULT_FILE_PATH);
