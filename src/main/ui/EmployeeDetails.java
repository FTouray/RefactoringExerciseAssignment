...
import command.AddRecordCommand;
import command.DeleteRecordCommand;
import command.EditRecordCommand;
import command.FirstRecordCommand;
import command.LastRecordCommand;
import command.NextRecordCommand;
import command.PreviousRecordCommand;
import command.SearchByIdCommand;
import command.SearchBySurnameCommand;
import model.Employee;
import model.EmployeeFactory;
import storage.RandomFile;
...
public class EmployeeDetails extends JFrame implements ActionListener, ItemListener, DocumentListener, WindowListener {
	...
	private Vector<Object> getAllEmloyees() {
		...
		do {
			...
			empDetails.addElement(currentEmployee.getPpsNumber());
